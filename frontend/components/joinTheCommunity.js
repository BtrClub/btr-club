...
export default function JoinTheCommunity() {
  return (
    <section className="bg-neutral-100 py-16">
      <section className="max-w-screen-xl bg-black mx-auto sm:py-6 lg:py-8 lg:px-6 flex flex-col items-center text-lg">
        <h2>Join the community</h2>
        <p className="sm:pt-4 pt-6 text-center">
          Learn more about BTR, watch the youtube videos to get more crypto
          <br />
          knowledge, chat with the team, and others in the community.
        </p>
        <section className="flex items-center justify-evenly w-4/6 sm:pt-14 pt-10">
